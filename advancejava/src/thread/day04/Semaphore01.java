...
public class Semaphore01 {
    public static void main(String[] args) throws InterruptedException {
        ...
        //What is the differences between semaphore and synchronized

        Semaphore semaphore = new Semaphore(3); //3 cars can be parked at most
        Thread.sleep(2000);
...
class Car extends Thread{
    ...
    public void run() {
        try {
            ...
            //suppose that eac car can be parked for hours
            for(int i=1; i<=4; i++){
