...
//        thread1.start();  in this way threads are start at the same time end terminate when the thread completed its task
//        thread2.start();
//        thread3.start();
//        thread4.start();
//        thread5.start();
...
//        thread10.start();
        ...
        service.execute(thread1);  //in this way according to the determined number threads start and when each thread terminate the other one start
